            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 w-full">
              ...
              <div className="flex-1 w-full px-2">
                ...
                <div className="w-full max-w-full overflow-hidden">
                  <p
                    className={`text-sm text-gray-700 whitespace-pre-wrap break-all transition-all   duration-200 ${
            ...
            <div className="flex border-b border-neutral-200/20">
              {authUser.role === "artist" && (
                <>
                  ...
                  <button
                    className={`flex-1 py-4 font-medium ${
                      activeTab === "mostliked" ? "border-b-2 border-black" : ""
                    }`}
                    onClick={() => showContent("mostliked")}
                  >
                    Most liked
                  </button>
                </>
              ...
              <button
                className={`flex-1 py-4 font-medium ${
                  activeTab === "suggested" ? "border-b-2 border-black" : ""
                }`}
                onClick={() => showContent("suggested")}
              >
                suggested
              </button>
            </div>
              ...
              <div className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {suggestedUsers.map((user, index) => (
                    <div
                      key={index}
                      className="w-full h-full flex flex-col bg-gray-400 border border-neutral-200/20 rounded-lg space-x-4 p-4"
                    >
